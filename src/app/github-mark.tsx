export const REPO_URL = "https://github.com/Natthakrittxx/stash";

// The GitHub octocat mark. Inline (matching the project's per-file SVG icons)
// but shared because it's used on two surfaces — one path, one source of truth.
